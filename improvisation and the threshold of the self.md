...
Then, nearly two and a half years after the initial studio-based research and while I was drafting this writing, my colleagues Siobhan Davies and Rosemary Lee shared with the C-DaRE research team (on 16 April 2026) a questioning process designed to elicit precise responses to remembered felt experiences. The process seems to have much in common with micro-phenomenological interviews [see @petitmengin-2006-describing; @petitmengin-2019-discovering]. On a methodological whim I asked Rosemary to work with me to integrate that questioning process into this research. In May 2026 she and I met online twice to push deeper into my memory of experiences while dancing.
...
Our research-based dancing was a somatic practice called [[authentic movement]], which normally involves two people taking turns in two different roles: a mover/dancer who improvises movement with eyes closed, and a viewer or witness who observes. Both the mover and witness attempt to avoid making judgments on any aspect of the experience. Each iteration of the practice is followed by a period of reflection between the two participants.[^am]
...
This research differs from work that analyses movement [e.g. @koch-2011-movement], isolates particular experiential qualities [e.g. @sheets-johnstone-2011-movement; @sheets-johnstone-2011-primacy; @ehrenberg-2015-kinesthetica], or even artist-scholars presenting discrete episodes of practice research [see @ellis-2023-ecosystemic]. Instead, the research is a phenomenological cross-section of _awareness while dancing_ which I treat as the corporeal and material substrate of the analysis. **add here or just below contribution to dance improv (in fact, all contributions here — is there just two?)**

The studio work with Katye and this analysis extend previous work in which I have explored the ways in which authentic movement meets epistemology [@ellis-2020-corporeal] and questions of documentation [@ellis-2020-currency]. **need to be specific re questions of doc**.

Therefore, the studio-based work with Katye becomes a case study of a body-based mindfulness practice (originating in dance practices) that is distinct from questions of skill and cognition in flow ([e.g. @montero-2018-thought]) but that overlaps with a form of attentional expertise [see for example @lutz-2008-attention]. -- this idea needs clarification. Merge with contributions? or link to top-down predictions/agency/disattention (Seth) — link to other improv writers?
...
The trajectory of each improvisation is described clearly across both retrospective spoken data sets: 
...
Crucially, there is no clear memory from within this experience when the organiser disappears and I know it only through the return to deep sensory dancing. In the second interview with Rosemary, I describe this return as a change in which 'It feels like the _I_ disassembles. And then gets reconstituted' (Ellis, 19 May 2026).

This reconstitution is not located in a single body part. Rather, ordinary embodied experience reappears as distributed sensation:

> So I come back to my body in the regular way in which we inhabit it, that there's, you know, weight in my elbows, I can feel pressure in my toes or under my feet or depending on, you know, what position I am in the room or whatever. So that they become, I become. I re-awaken or become re-aware [...] of ... someone who has a body (Ellis, 19 May 2026).
...
### Dance and somatic practices: moving and being moved

The dancers interviewed by Kent De Spain for _Landscape of the Now_ [-@despain-2014-landscape] seem to describe experiences on either side of the threshold. De Spain himself alludes to the phenomenon of _being danced_ in how when dancing he moves between acting, responding and 'being acted upon' [@despain-2014-landscape p.72]. He describes how the experience is both frightening and liberating, because both emotions reveal that he is not the source of all his actions. 
...
– Kent De Spain [-@despain-2014-landscape p.52]

Reduced desire, or the absence of desire, is a recurrent theme in improvised dancing. Kirstie Simson has long used a practice explicitly called 'hands that don't want anything' [@ellis-2009-hands], while Steve Paxton seems to infer the presence of a threshold when he describes how 'little sprits' like imagery and desire stop as if 'the mind has just been surgically removed' [Paxton, in @despain-2014-landscape p.77]. In Paxton's description there are hints of how Sheets-Johnstone references Kristeva's _primordial semiotic of gesture_ that affords 'no distinction between signifier and signified, and in which a bodily doing sets forth relations without specifying objects within these relations' [@sheets-johnstone-1981-thinkinga p.403]. 
...
I use the Tibetan Buddhist word _bardo_ as it describes 'a transitional period between two states of existence' [@buswell-2014-princeton p.114] when habitual identities loosen, including at the moment of death. The spiritual dimension of thresholds underpins many body and dance-based practices. Authentic movement itself was developed as a dyadic practice by Janet Adler and is primarily used as a somewhat mystical form of movement therapy. For example, Adler writes how 'the moving body invites an awakening – summoning the human soul toward a return, a reunion with the eternal' [@adler-2015-mandorla p.218] and that in the dancing there is the risk of 'experiencing the ineffable fear of a death of oneself as one has known oneself to be' [@adler-2015-mandorla p.222]. 

Healing and therapy through movement are vital concerns to many somatic practitioners [@eddy-2009-brief] and their practices are often tied to experiencing one's true self. In her phenomenology of dance writing _Consciousness Matters_ Sondra Fraleigh writes that through somatic bodywork 'I have also experienced the surfacing of this healing landscape, that aspect of my core self that I have come to trust as mythic and creative' [-@fraleigh-2000-consciousness p.58]. 

While such accounts frame somatic practice as a route toward healing and the recovery of a core or mythic self, other writers situate these same practices less in terms of self-discovery than in relation to contemplative or meditative presence. Marcow-Speiser and Franklin [-@marcow-speiser-2007-authentic] acknowledge the contemplative aspects of authentic movement that overlap with 'traditional meditative practices' [-@marcow-speiser-2007-authentic p.70] and the 'radical gesture of "just being" in the present moment' [-@marcow-speiser-2007-authentic p.70]. They say directly that authentic movement is a meditative practice in which the present moment is not simply a point in time but a mode of awareness. (note: 'mode' of awareness just doesn't make sense. It's more like a mode of attention. awareness happens to us. )

In _Thinking in Movement_ [-@sheets-johnstone-1981-thinkinga] Sheets-Johnstone refers to an ongoing present: 

> My thinking in movement is thus not an assemblage of discrete gestures happening one after the next, but an enfolding of all movement into a perpetually moving present [@sheets-johnstone-1981-thinkinga p.405]. 

Such accounts of presence are and have been a core component of describing experiences of dancing: being in the moment, dwelling in experience, embodied awareness, somatic attunement, etc. Together they seem to overlap with what is theorised in psychology as _flow_ [@csikszentmihalyi-2009-flow] – a state of absorbed, present-centred engagement.

Worth discussing Katye's SIBAM (gestalt) stuff -- as 'dancing' side -- still deeply tuned. 

## findings / discussion (contribution)

### conditions for the experience: practice research

- conditions matter -- to be precise/specific about what kind of practice this is
- this is a 'plea' for specificity 
- untangle from Montero? 
- overlap with flow? 

Practice as condition-setting and disclosure, not data generation in a narrow sense. that is:
	
First, it sets conditions. Through repetition, constraint, attentional orientation, witness–mover relations and temporal framing, the practice shapes a field in which particular kinds of experience become more likely. It biases perception, agency and self-relation without determining outcomes. Nothing is forced and nothing is guaranteed.



Second, it enables disclosure. What matters is what shows up under those conditions, often unpredictably, and often only retrospectively recognisable. These disclosures are experiential, relational and situational. They are not 'generated' in the sense of being produced on demand, nor do they pre-exist as stable objects waiting to be collected.

So the claim rejects a narrow research logic in which practice is valuable only insofar as it yields codifiable data. Instead, practice functions more like an experimental ecology: it creates the possibility for thresholds, shifts or recognitions to occur, which can then be articulated, reflected on or analysed after the fact.

In short: the practice does not make data. It makes conditions under which something can be seen.

### body-mindfulness

Given these specific aspects of the movement practice, my hunch is that the closest link between our version of authentic movement and other practices is with body-mindfulness practices; e.g. like body awareness practices in Mehling 2011 -- think this is a finding?? 
...
gradual changes but then absolute. dawn/dusk not right -- like the sun is setting and setting then once it's gone complete darkness. Or a gradient like that suggested by [[Josipovic - Implicit–explicit gradient of nondual awareness]]. Made me think it's more like the transition into general anaesthesia. 
...
### the limits: what cannot be said
...
[[Herbert - The Body in the Mind#^9fb6b4]] 
...
> However, at times Consciousness divides the totality of experience into two camps. Everything that is part of the ‘not me' camp is called ‘the world.' Everything that is part of the ‘me' camp is called ‘the body/mind.' [@spira-2008-transparency]
...
For the purposes of this writing I consider awareness and consciousness as the same thing [e.g. @damasio-2010-self] and David Chalmers – The Conscious Mind (1996)

> One cannot say anything about the awakened state; one can only talk about the sleeping state. One hints at the awakened state. (Anthony de Mello, Awareness the Perils and Opportunities of Reality)

> According to the phenomenological approach, the process of eidetic variation is assumed to produce a re-enacting of experience, while according to Buddhist philosophy re-enactment or approximation to reference experience only creates additional experience. Experience does not have any structure or essence that needs to be described or explored since structure and essence is itself an experience. According to Zen Buddhism, experience cannot be captured through rational analysis but it remains what it is—simply experience. The conversations of the interviewee and facilitator during eidetic variation are certainly also experience. However, these cannot replace, copy, or re-enact an experience, as this would imply a dualistic view of experience that is discrete and locatable in time and space. (Christian U. Krägeloh, Phenomenological Research Fails to Capture the Experience of Nondual Awareness)
...
First, that while dancing there is some kind of threshold which separates experiences that are different in kind, such that there lies some path or transition between them (even if that transition is momentary or more akin to a jump cut).
...
> Two mistaken inferences are then commonly made: one that nondual awareness is a mere absence of phenomenal contents akin to deep sleep, the other that nondual awareness can only be known retroactively through a subsequent cognition that takes that unconscious state as its
object. [@josipovic-2019-nondual p.278]

- he mentions this specifically -- in relation to discussion of substrate. See also:

> Episodes of explicitly present NDA that is isolated from other phenomenal content, such as those that can occur with contemplative practice or in lucidity during deep sleep, can be regarded as episodes of MPE since no phenomenal content is present other than awareness itself (Josipovic, 2019). [@josipovic-2020-nondual p.2]

- mentioned elsewhere in this document re yoga sleep
...
does Sheets-Johnstone reify the body? 
...
Crucially, this framing avoids both mystification and reduction. It neither romanticises the experience as transcendence nor explains it away as attentional narrowing or dissociation. It simply names what the practice appears to disclose: that lucidity does not depend on a self being present to guarantee it, and that awareness can be clear, responsive and precise without being organised around an _I_.
...
- this feels like where I am going with the alignment of the context/conditions -- as a modulation of environment. part of that environment is the subsidence of desire.
...
in Western mindfulness it is called open awareness [@taft-2022-meditation n.pag.]; and in the Dzogchen Tibetan Buddhist tradition it is _rigpa_ or pristine awareness -- where awareness recognises itself without interference [@wangyalrinpoche-1998-tibetan]. 
...
[^zone]: In Arthur Ashe's autobiography he describes being beaten by Bjorn Borg who was 'in what we call the zone'. _The zone_ was a reference to the TV series _The Twilight Zone_ and meant 'another world' [@ashe-1975-arthur].


[^nine]: Scientists have long measured flow experiences using a scale with nine dimensions. These nine dimensions are widely cited but are not necessarily stable experiential categories [@peifer-2022-scoping].
...
Each session followed this pattern. The length of each practice varied, but most practices were timed to be 30 minutes. For the second session on the same day the person who moved first in the morning witnessed first in the afternoon. We also ensured that whomever had danced first in the morning witnessed first the morning of the following day's work. Each of our 13 unstructured conversations was around 40 minutes long:

even though I didn't begin direct work on this book chapter[^git] until September 2025 and the bulk of the writing and analytical work happened between February and August 2026. 
...
- intro: dancing and being danced
- arriving at the threshold
- the dancing: authentic movement (its properties — or save that for analysis?)
- see ‘codifiable data’ in the doc re PaR
- delimit: flow (?), phenom of self (need to mention!), self-reporting (think I’ll ignore that)

why does it matter? 
- primary contribution is to dance-improv practices? 
- movement bias?
- methodological ? 
...
The person who has written extensively about the sense of self changing when dancing (and doing other high level skills) is Barbara Montero. And Montero does not think or believe that the self is lost while doing complex skills. Her book _Thought in Action_ [-@montero-2016-thought] is a reaction to the appealing (and seemingly uncontested) idea that thinking interferes with high-level performance. Related is idea that because expert activity appears effortless then it must also be unreflective. She refers to her 'theory of effortful expertise' [@montero-2016-thought p.6]. 

> what is more often meant by the claim that expert action should be easy is that during a performance, an expert doesn't and shouldn't think much about what she is doing; rather, the expert acts intuitively and automatically. [@montero-2013-dancer p.304]
...
Note conflation of mind with self? 
...
> Equations in physics model idealized situations. They don’t describe things as they are in themselves—an impossibility anyway, as we can’t know things as they are in themselves—but rather phenomena mapped through our observations and measurements, simplified to ignore effects that are believed to be insignificant. In other words, equations are abstract constructions, translations from the world of perception to the world of reason: they originate in experience but exist in thought. (Adam Frank, The Blind Spot Why Science Cannot Ignore Human Experience)
...
> A generation after Kierkegaard insisted that ['the moment is not properly an atom of time but an atom of eternity'](https://www.themarginalian.org/2017/04/18/kierkegaard-concept-of-anxiety-time/) and a century before Mary Oliver drew on Blake and Whitman to observe that ['all eternity is in the moment,'](https://www.themarginalian.org/2014/09/10/mary-oliver-on-punctuation/) (Maria Popova, The Ecstasy of Eternity: Richard Jefferies on Time and Self-Transcendence)
...
### 5.3 Why the threshold matters
- For dance research:
	+ Precision without mystification.
- For phenomenology:
	+ Value of studying moments where method strains.
...
Athletes have long given accounts of being in _the zone_[^zone] in which playing becomes effortless, one's sense of time is altered and unnecessary thoughts cease. In 1990 the Hungarian-American psychologist Mihály Csíkszentmihályi published the first edition of his seminal work _Flow: The Psychology of Optimal Experience_ [-@csikszentmihalyi-1990-flow] which summarised decades of research into the positive aspects of human experience. Csíkszentmihályi describes how the phenomenology of flow[^nine] includes effortless and intense concentration, loss of self-consciousness, transformation of time and when action and awareness merge and attention is fully absorbed in the present moment in the activity [@csikszentmihalyi-2009-flow]. 
...
> So loss of self-consciousness does not involve a loss of self, and certainly not a loss of consciousness, but rather, only a loss of consciousness of the self. What slips below the threshold of awareness is the concept of self, the information we use to represent to ourselves who we are. And being able to forget temporarily who we are seems to be very enjoyable. When not preoccupied with our selves, we actually have a chance to expand the concept of who we are. Loss of self-consciousness can lead to self-transcendence, to a feeling that the boundaries of our being have been pushed forward.
 -- Mihály Csíkszentmihályi [-@csikszentmihalyi-1990-flow p.64]

'flow attempts to fortify the self' [@csikszentmihalyi-1990-flow p.105]
'The self becomes complex as a result of experiencing flow' [@csikszentmihalyi-1990-flow p.42]
The self is also 'is also one of the contents of consciousness' [@csikszentmihalyi-1990-flow p.34]

- [[the dextrous butcher]] -- also book Losing Oneself by Garfield
...
- Montero [@montero-2016-thought p.182] -- talking about proprioception, makes clear different conditions (music, with others): be clear that there is something simplified in this practice: no sight, no music, no goal (including 'good performance') ... it is pared back a long way (even to the point of not even making shapes or forms with the body). She writes of 'immersed in this experience of movement' (p.182) -- it's a pretty good description.

> When the pleasure of expert skill does outweigh the pain, one way that dancers (and likely others) experience this pleasure is in 'bodily immersion,' that is, in the feeling of being in contact with every point of one's body. [@montero-2016-thought p.182]
- this 'being in contact' is very curious. 

> And even in cases where the only thing on one's mind is the feeling of movement, it seems that this feeling can in part comprise a sense of the self. In other words, there seems to at least be no direct path from bodily immersion to the loss of self. [@montero-2016-thought p.183]
- first I need to be clear what bodily immersion is -- how clear is she. See [[Montero - Thought in Action#^5cef29]]

- Csikszentmihalyi's work is in peak experience not peak performance [@montero-2016-thought p.184] and also see p.185 in the quote about Yeat's Among School Children. 
...
I start by tracing the conceptual neighbours of the threshold through three lenses: dance and somatic practices, flow and non-dual awareness.  
...
Such widening of attention is more _field-like_ if the sensorium can be described as a field. 
...
I say expert because it connects the work to research by philosopher (and former ballet dancer) Barbara Montero that examines the role of thinking in expert performance. For Montero an expert is a professional-level practitioner developed through long deliberate practice who is actively trying to improve:

The experience on the other side of the threshold has many names from different traditions aside from dancing, and shares a disruption of subject–object organisation. 

primarily deploys improvisation as a performative act. However, she also 

Steve Paxton talks of the body taking over
...
"the conscious development of relationships between the moving self and the inner witness, between the individual body and the collective body, between the self and the Divine" [@adler-2002-offering p. xix]


who developed earlier _movement-in-depth_ work by Mary Starks Whitehouse. It 

takes dance improvisation to be performative, in which "the process of creating is not the means of realizing _a_ dance, it is _the_ dance itself" [@sheets-johnstone-1981-thinkinga p.399]. Her key argument is that movement is a form of thinking and intelligence that is a dynamic and pre-linguistic mode of cognition understood corporeally. Sheets-Johnstone refers 
...
While there is substantial scholarship on improvisation as composition [@albright-2003-taken, @midgelow-2019-oxford], there is comparatively little work that explicitly distinguishes non-compositional improvised dancing from improvisation understood as composition. 

This lack is a legacy of the political drive within dance practice to legitimate improvisation as a form of composition as important as choreography. Perhaps Chrysa's work is important in foregrounding the labour, skill and intelligence of the dancer.  

In _Taken by Surprise_ [-@foster-2003-takena] Susan Foster assumes that improvisation is something performed: "After all, to improvise is to compose extemporaneously and composition is an arrangement into proper proportion or relation" [@foster-2003-takena p.7]. 

Curiously, Foster notes that improvisation "most closely resembles a grammatical category found in the verb forms of many languages [...] known as the middle voice" [-@foster-2003-takena p.7]. Such words are neither passive or active constructions and the subject is neither acting or is acted upon. Her example of the equivalent in English is "shit happens" (p.7).

- but the subject is implied by context. it happens to someone. is this right?
- compare with Goldstein's passive constructions. It would be "shit happening"

In _Taken by Surprise_ [-@foster-2003-takena] Susan Foster takes dance improvisation to be part of a culturally recognised field and deploys it at the level of its aesthetic and epistemic effects, not its internal thresholds or experiential mechanics. The writing seeks to validate (dance) improvisation as a challenge to hegemonic thinking. 

> But the experience is profound and undeniable—sometimes I am acting, sometimes I am responding, and sometimes I am being acted upon—and it reveals so much about how we interact with the world around us. It is both frightening (I am not the source of all of my actions) and incredibly liberating (I don't have to be the source of all of my actions). And in that space between freedom and control is a landscape of rich possibilities. If you turn your awareness to the source of your movements and desires, what do you find? And what is the difference between the kinds of things you choose to do and the kinds of things that are "chosen" for you? [@despain-2014-landscape p.72]
...
> The known also includes an individual body's predisposition to move in patterns of impulses established and made routine through training in a particular dance tradition as well as the body's predilection for making certain kinds of selections from a vocabulary or a sequence of movements. [@foster-2003-takena p.4]

> That moment of wavering while contemplating how, exactly, to execute an action already deeply known, belies the presence of improvised action [@foster-2003-takena p.4].

- Foster also discussed the middle voice of "shit happens" (nonactive / nonpassive voicing)

The mover tries to let things happen without concern for what it looks like or how to interpret things

make note that clearly authentic movement does not speak for all dance -- talking about a specific somatic attunement. but it forks into many practices (and is forked from many practices). How it looks is not important. Start Section 2 with this.
...
> These approaches aim to cultivate a particular quality of body awareness characterized by non-judgmental (Mehling, Wolf E. et al, Body Awareness: a phenomenological inquiry into the common ground of mind-body therapies)

- check it's not other way around - that the non judging makes a particular kind of attention possible 
