...
- vagueness vs holistic: to what extent is somatics dependent on vagueness? 
...
This is some writing about interoception. But need to get there -- describe thinking behind the line I draw from the claims we make to understanding possible mechanisms for change through somatic practices. Interoception is fashionable, but could act as a striking bridget between different epistemic worlds, different belief systems, and our relationship to the truth. 
...
- On what grounds are we making claims? (again, Ginot makes this clear about endegonous thinking, and how it circles in on itself - see below). However, not getting at mechanisms for change. 
...
1. "the way somatics puts scientific discourse"[@ginot-2010-shusterman p.13]
2. " a first-person narrative of recovery"[@ginot-2010-shusterman p.13] (probably just leave this out)

> to my knowledge, no single "modern" somatic method exists that fails to make this connection between subjective experience and objective proof.[@ginot-2010-shusterman p.14]
...
- noting that the Batson article includes Margaret Wilson who wrote [[six views of embodied cognition]]
...
this article by Batson et al. is broad overview of ways in which dance science and somatics might serve each other in a 'holistic' way: "an integration of lived experience with objective methodologies, each telling its own ‘narrative’ to provide a more coherent whole."[@batson-2012-integrating pp.189-190]
...
## body awareness as bridge between science and somatics
...
(Non)-judgement and discernment cannot be practiced without awareness. See [[definition of mindfulness#^ec4a6e]]
Role of attention. 
- growing body of work ... (see names for science-based stuff in [[a list of somatic practices]])

- [[definition of body awareness]] Mehling

It is a safe assumption that given the [[definition of body awareness]] such processes vary between individuals and are able to be improved with practice/training. Evidence for this? See [[Mehling - If It All Comes Down to Bodily Awareness#^f659e6]]. Mehling also discusses [[mediation analysis]] -- a statistical technique -- in which a third mediating variable influences the independent variable which then effects change in the dependent variable. Worth considering what a collection of IV and DVs might be here? e.g.  

- [[five stages of development of body awareness]]
- draw line between somatic practice and body awareness, and then interoception. 


## interoception (as pivotal in understanding body awareness)

![[ngram-interoception.png]]

interoception (location in brain) -- but multifaceted. Not just interoception located there (can't remember the article though -- one of recent ones??)

First defined by Sherrington in 1906 as ability to detect signals coming from the viscera (check this). The definition was expanded by Craig (2002) to be "the sense of the physiological condition of the body beyond the viscera"[@valenzuela-moguillansky-2017-exteroceptive p.2] Craig's definition linked interoception to afferent pathways that carry information from sensory receptors in the body's tissues to the central nervous system to help regulate homeostatic function.
...
> Recent findings [show] that all feelings from the body are represented in a phylogenetically new system in primates. This system has evolved from the afferent limb of the evolutionarily ancient, hierarchical homeostatic system that maintains the integrity of the body. These feelings represent a sense of the physiological condition of the entire body, redefining the category ‘interoception’.[@craig-2003-interoception p.500]

Afferent neurons carry information from sensory receptors in the body's tissues to the central nervous system. The autonomic nervous system is the body's mostly unconscious method that underpins homeostatic regulation. 

Interoception has different definitions. Wolf E. Mehling is a professor of Family Community Medicine at UCSF and has published widely on the science of interoception. Mehling defines interoception narrowly as "the perception of physical sensations from inside the body"[@mehling-2020-if p.255] including sensations related to organ function like heartbeat, respiration, satiety and emotion-based aspects of the autonomic nervous system. (based on Sherrington and Craig). His broad definition is any perception that begins inside the body. (this seems similar to Eddy's)

Interoception mostly consists of unconscious processes in homeostatic regulation. Yet there are aspects of interoception that human are able to be aware of. Mehling describes, neurologically, that "bodily awareness is the part of proprioception and interoception of which one can be aware."[@mehling-2020-if p.255] 
...
- look at [@ceunen-2016-origin]
- look at [@craig-2002-how]
...
- thinking about specialist and generalist audiences and being inside and outside that field. That somatics is in on itself (as Ginot says) and missing too many opportunities

## opportunities

- there are opportunities here for how we extend beyond our field. The work that needs to happen. The role understanding of dance and somatic practices might play in contributing to the science. 
- of course, somatics could just continue as is -- there's gold in them thar hills (for some at least). It could continue to propagate new names, techniques and trademarks and we could keep talking among ourselves. Their remains value for people given its current epistemic and cultural status. Perhaps a field based on belief systems in striking contrast to the status quo of science needs those conversations, needs to feel that support, needs to keep being able to reassure itself.  
- but what can't we say about somatic practices? What claims are we not able to make? At the moment it seems like anything goes. It's research's wild west.

# Acknowledgements

- Emma Meehan for first sharing the Ginot article with me
- Scott deLahunta for dialogue
