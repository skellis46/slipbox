...
I have six observations to share today. These observations emerged from this analysis of the 85 articles. However, the articles I use to exemplify these observations were all drawn at random from the entire list of 272 JDSP articles. For example, I drew the quote-claims I presented at the beginning from the first four articles randomly selected from the entire JDSP corpus. At no stage did I randomly select an article and then return it to the pile because it didn't suit my needs or desires. This reveals my confidence about how common these observations are in the JDSP corpus. 
...
Perhaps though the poetics of abstract language are a feature and not a bug? My sense is that there is tremendous value to continue to develop the poetics of the field and the ways in which both poetic and scholarly abstractions might strengthen or embolden academic understandings. Yet I also worry that with abstractions come dangers. Who and what might we be exploiting through deploying abstractions, even if the exploitation is of an epistemic space? 

[right]

### 2. Mechanisms are as rare as hens' teeth

I catalogued whether articles contained any description of the mechanism for the beneficial claims made on behalf of each somatic practice. In other words, did the articles describe _how_ the benefits happen? Few articles in JDSP seem to do this: about one in five of the 85 I analysed. In most cases, the practice is implicitly also the mechanism: somatic practice x can lead to effect y due to the somatic practice process x. 
...
I'm curious about this phrase _epistemic credibility_. Without the kind of process that Ellerton describes then I worry that we end up in some kind of [right] vicious circle of epistemological impoverishment in which there are no limits to the claims made on behalf of somatic practices, which means there are no grounds to debate such claims, which means there are no limits to the claims, etc.
...
This last observation is about the word _can_. Here's another article drawn randomly from all 272 articles. 
...
Why does this _can_ matter? It matters because how does anyone refute such a _can_? Yes, somatic practice X can produce effect y, but it's so loose. Under what conditions? When does it NOT produce such an effect? The _can_ inadvertently serves as a way to reduce the possibility of argument or refutation. Or perhaps, more positively, it is a form of epistemic humility; of not wanting to make strong assertions. 
...
I think a version of Pascal's wager is useful here [@noauthor-2020-pascal n.pag.]. I think the cost of my being right far exceeds the cost of my being wrong. If I am wrong but we still enter the debates, continue to challenge the claims we make etc, then I think somatics scholarship and epistemology is strengthened. But if I am right and we do nothing then the potential academic cost to our discipline is high.  
